...
def main():
    ...
    file_path = os.path.join(opt.model_dir,"ADE_FDE_e2e_latency.txt")
    ...
    for use_laplace in use_laplace_options:
        ...
        for latency in latency_list:
            ...
            log_file.write('ADE: {} FDE: {} latency: {}\n'.format(torch.mean(ADE_tensor, dim=0),torch.mean(FDE_tensor, dim=0),latency))
            log_file.close()
